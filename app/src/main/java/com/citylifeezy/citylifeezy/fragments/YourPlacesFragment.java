...
import com.citylifeezy.citylifeezy.ListActivity;
 ...
 */
public class YourPlacesFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static YourPlacesFragment newInstance(Context context) {
        YourPlacesFragment f = new YourPlacesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_your_places, container, false);
...
//                        Log.d("Error.Response", error.getMessage());
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        myButton = (Button) getView().findViewById(R.id.favoriteButton);
        ...
        gpsView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                YourPlacesFragment.this.GetMyLocation();
            }
        });
    ...
    private void NextPageMethod() {
        Intent inten = new Intent(getActivity(), ListActivity.class);

        YourPlacesFragment.this.startActivity(inten);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        YourPlacesFragment myListFragment = new YourPlacesFragment();
...
//                }
        ...
        String ar_cond_1[] = new String[99];
        String ar_cond_2[] = new String[99];
        String ar_cond_3[] = new String[99];
        String ar_cond_4[] = new String[99];
        String upDateTime[] = new String[99];
            ...
            if (dummy == i) {
                ...
                if (trafficMin.isGreaterThan(minInterval)) {
                    ...
                    if (Jam_Area_1[i] == -9) {
                        ...
                        ar_cond_1[i] = AreaName[Jam_Area_1[i]];

                        ar_cond_1[i] = "- " + ar_cond_1[i] + " : " + myArea_Stat_1[i];
                    }
                    ...
                    if (Jam_Area_2[i] == -9) {
                        ...
                        ar_cond_2[i] = AreaName[Jam_Area_2[i]];

                        ar_cond_2[i] = "- " + ar_cond_2[i] + " : " + myArea_Stat_2[i];
                    }
                    ...
                    if (Jam_Area_3[i] == -9) {
                        ...
                        ar_cond_3[i] = AreaName[Jam_Area_3[i]];

                        ar_cond_3[i] = "- " + ar_cond_3[i] + " : " + myArea_Stat_3[i];
                    }
                    ...
                    if (Jam_Area_4[i] == -9) {
                        ...
                        ar_cond_4[i] = AreaName[Jam_Area_4[i]];

                        ar_cond_4[i] = "- " + ar_cond_4[i] + " : " + myArea_Stat_4[i];
                    }


                    upDateTime[i] = "Updated: " + updateTime + "ago";
                }
            }
        ...
        try {
            ...
            for (int i = 0; i < getCount(); i++) {
                ...
                if (
                        favouritesBeanSampleList.get(i).getArea_Name() != null ||

                                !favouritesBeanSampleList.get(i).getArea_Name().isEmpty() ||

                                favouritesBeanSampleList.size() <= 0
                        ) {

                    if (myArrayList.contains(favouritesBeanSampleList.get(i).getArea_Name())) {

                    } else {


                        myArrayList.add(favouritesBeanSampleList.get(i).getArea_Name());


                        String savedAreaName = favouritesBeanSampleList.get(i).getArea_Name();
                        ...
                        if (savedAreaName.equals(AreaName[i]) || savedAreaName == AreaName[i]) {
                            SetMarkerMethod(AreaName[i], ar_cond_1[i], ar_cond_2[i], ar_cond_3[i], ar_cond_4[i],
                                    upDateTime[i], AreaLatLng_geo_Code);
...
//                }
            ...
            Toast.makeText(mContext, "Please Add at least one Area to Activate the Favorite Mode!",
    ...
    private void SetMarkerMethod(String area_name,
        ...
        MarkerOptions mOptions = new MarkerOptions()
                .position(new LatLng(lat_long.latitude, lat_long.longitude))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.trafficpoint))
                .visible(true);
